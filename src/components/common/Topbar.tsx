  ...
  return (
    <AnimatePresence>
      {showTopbar && (
        ...
        >
          <div className="main-container flex justify-between items-center py-3 px-0 sm:px-4 lg:px-10 relative overflow-hidden">
            {/* Black Friday Tag */}
            ...
            <div className="flex-1 text-center overflow-hidden px-2">
              <motion.p
                ...
                className="text-yellow-300 font-medium text-xs md:text-base whitespace-nowrap"
              >
            ...
            <div className="flex-shrink-0 hidden md:block">
              <Link to="/shop">
                <button className="bg-yellow-400 hover:bg-yellow-300 transition-colors duration-200 py-2 px-4 md:px-3 rounded-md text-black font-semibold flex items-center gap-x-2 shadow">
