                        ...
                        <div className="grid gap-4 grid-cols-2 sm:gap-x-6 sm:gap-y-4">
                          ...
                          <div className="w-full">
                            ...
                            <input
                              ...
                              id="Address"
                              className="text-sm rounded-lg block w-full p-2.5 bg-gray-50 border-gray-600  focus:outline-none"
                              placeholder={`e.g. ${userProfileFromDb?.address?.address || "Jinjirtala"}`}
                          ...
                          <div className="w-full">
                            ...
                            <input
                              ...
                              id="city"
                              className="text-sm rounded-lg block w-full p-2.5 bg-gray-50 border-gray-600  focus:outline-none"
                              placeholder={`e.g. ${userProfileFromDb?.address?.city || "Dhunat"}`}
                          ...
                          <div className="w-full">
                            ...
                            <input
                              ...
                              id="state"
                              className="text-sm rounded-lg block w-full p-2.5 bg-gray-50 border-gray-600  focus:outline-none"
                              placeholder={`e.g. ${userProfileFromDb?.address?.state || "Bogura"}`}
                          ...
                          <div className="w-full">
                            ...
                            <input
                              ...
                              id="country"
                              className="text-sm rounded-lg block w-full p-2.5 bg-gray-50 border-gray-600  focus:outline-none"
                              placeholder={`e.g. ${userProfileFromDb?.address?.country || "Bangladesh"}`}
                          ...
                          <div className="w-full">
                            ...
                            <input
                              ...
                              id="postalCode"
                              className="text-sm rounded-lg block w-full p-2.5 bg-gray-50 border-gray-600  focus:outline-none"
                              placeholder={`e.g. ${userProfileFromDb?.address?.postalCode || "5850"}`}
                          ...
                          <div className="w-full">
                            ...
                            <input
                              ...
                              id="mobile"
                              className="text-sm rounded-lg block w-full p-2.5 bg-gray-50 border-gray-600  focus:outline-none"
                              placeholder={`e.g. ${userProfileFromDb?.address?.mobile || "01740020464"}`}
