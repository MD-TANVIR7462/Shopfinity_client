    ...
    <div className="max-w-7xl mx-auto px-4 py-12">
      <div className="text-center mb-12">
        <h1 className="text-4xl font-bold text-green-600">
          Hello, {userProfileFromDb?.name?.split(' ')[0]} 👋
        </h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="col-span-1 bg-white p-6 rounded-2xl shadow-lg text-center">
          ...
          <p className="text-gray-500 flex justify-center items-center gap-1 text-sm mt-1"><MdEmail /> {userProfileFromDb?.email}</p>
          <p className="text-gray-500 flex justify-center items-center gap-1 text-sm mt-1"><MdPhone /> {userProfileFromDb?.address?.mobile}</p>
          <p className="text-gray-500 flex justify-center items-center gap-1 text-sm mt-1"><MdLocationOn /> {userProfileFromDb?.address?.city || 'City not provided'}</p>
        </div>
      ...
      <div className="mt-16 grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white p-6 rounded-xl shadow-lg">
          ...
          <ul className="space-y-3 text-sm text-gray-600">
            <li>🛍️ Placed order <span className="font-medium">#123456</span></li>
            <li>✅ Order <span className="font-medium">#123454</span> marked as completed</li>
            <li>📥 Updated profile details</li>
            <li>💬 Left a review for <span className="font-medium">Product XYZ</span></li>
          </ul>
        </div>
        ...
        <div className="bg-white p-6 rounded-xl shadow-lg">
          ...
          <ul className="space-y-3 text-sm text-gray-600">
            <li className="flex justify-between">
              <span><FaStar className="inline text-yellow-400 mr-1" /> Smart Watch</span>
              <span className="text-green-600 font-semibold">$120</span>
            </li>
            <li className="flex justify-between">
              <span><FaStar className="inline text-yellow-400 mr-1" /> Wireless Earbuds</span>
              <span className="text-green-600 font-semibold">$85</span>
            </li>
            <li className="flex justify-between">
              <span><FaStar className="inline text-yellow-400 mr-1" /> Backpack</span>
